...
/**
 * Branded back-in-stock email — forest-green primary + mossy mid-green accent.
...
<html lang="en">
  ...
  <body style="margin: 0; padding: 0; background-color: #EFE6D6; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #ffffff;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #EFE6D6; padding: 32px 16px;">
      <tr>
        <td align="center">
